public class IndiaInfo {
    public static void main(String[] args) {
        ...
        System.out.println("3. Festivals - Diwali, Holi, Eid, Christmas, Pongal, and many more are celebrated with joy.");
        System.out.println("4. Indian Cuisine - Spices and diverse food varieties from north to south.");
